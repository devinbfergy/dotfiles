...
tmux set -g status-left "#(claude-status-sessions)"
...
# Window status formats (with per-window claude indicators)
tmux setw -g window-status-format "#[fg=${thm_black4}]#{?@claude-waiting,#[fg=${thm_yellow}]󰅩 ,#{?@claude-active,#[fg=${thm_green}]󰅩 ,}}#{?#{window_name},#W,#{b:pane_current_path}}"
tmux setw -g window-status-current-format "#[fg=${thm_magenta},bold]#{?@claude-waiting,#[fg=${thm_yellow},bold]󰅩 ,#{?@claude-active,#[fg=${thm_green},bold]󰅩 ,}}#{?#{window_name},#W,#{b:pane_current_path}}"
